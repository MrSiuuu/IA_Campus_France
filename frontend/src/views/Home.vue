      ...
      <div class="max-w-screen-xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
        <div class="space-y-6">
          ...
          <ul class="space-y-3">
            ...
            <li><a href="#" class="text-slate-400 hover:text-white">Flux de travail automatisés</a></li>
            <li><a href="#" class="text-slate-400 hover:text-white">Traitement du langage naturel</a></li>
            <li><a href="#" class="text-slate-400 hover:text-white">Modèles IA personnalisés</a></li>
            <li><a href="#" class="text-slate-400 hover:text-white">Intégration API</a></li>
          </ul>
        </div>

        <div class="space-y-6">
          <h6 class="text-white font-medium">ENTREPRISE</h6>
          <ul class="space-y-3">
            <li><a href="#" class="text-slate-400 hover:text-white">À propos</a></li>
            <li><a href="#" class="text-slate-400 hover:text-white">Tarifs</a></li>
            <li><a href="#" class="text-slate-400 hover:text-white">API développeur</a></li>
            <li><a href="#" class="text-slate-400 hover:text-white">Carrières</a></li>
        ...
        <div class="space-y-6">
          ...
          <ul class="space-y-3">
            <li><a href="#" class="text-slate-400 hover:text-white">Conditions d'utilisation</a></li>
            <li><a href="#" class="text-slate-400 hover:text-white">Politique de confidentialité</a></li>
            <li><a href="#" class="text-slate-400 hover:text-white">Traitement des données</a></li>
            <li><a href="#" class="text-slate-400 hover:text-white">Sécurité</a></li>
            <li><a href="#" class="text-slate-400 hover:text-white">Cookies</a></li>
            <li><a href="#" class="text-slate-400 hover:text-white">RGPD</a></li>
          </ul>
        </div>
        ...
        <div class="space-y-6">
          ...
          <div class="!mt-8">
            <h6 class="text-slate-400 font-medium">Recevez des insights et mises à jour IA dans votre boîte mail</h6>
            <div class="mt-6">
              <a href="#" class="px-6 py-3 text-base rounded-full font-medium tracking-wide text-white border border-purple-600 bg-purple-600 hover:bg-purple-700 transition-all">S'abonner</a>
            </div>
          </div>
        </div>
      </div>
